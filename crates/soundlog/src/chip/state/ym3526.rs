//! YM3526 (OPL) chip state implementation.
//!
//! This module provides state tracking for the Yamaha YM3526 FM synthesis chip,
//! the original OPL chip with 9 FM channels.
...
/// YM3526 has 9 FM channels
const YM3526_CHANNELS: usize = 9;

/// YM3526 recommended storage
pub type Ym3526Storage = SparseStorage<u8, u8>;

/// YM3526 register state tracker
///
...
impl Ym3526State {
    /// Create a new YM3526 state tracker
    ///
    /// # Arguments
    ///
    ...
    pub fn new(master_clock_hz: f64) -> Self {
        Self {
            ...
            master_clock_hz,
            registers: Ym3526Storage::default(),
        }
    }
...
impl ChipState for Ym3526State {
    type Register = u8;
    type Value = u8;
