//! YM2608 (OPNA) chip state implementation.
//!
//! This module provides state tracking for the Yamaha YM2608 FM synthesis chip,
...
/// YM2608 has 6 FM channels + 3 PSG channels = 9 total channels
/// (ADPCM channels are not tracked for tone)
const YM2608_CHANNELS: usize = 9;
const YM2608_FM_CHANNELS: usize = 6;

/// YM2608 recommended storage
pub type Ym2608Storage = SparseStorage<u16, u8>;

/// YM2608 register state tracker
///
...
pub struct Ym2608State {
    ...
    registers: Ym2608Storage,
}

impl Ym2608State {
    /// Create a new YM2608 state tracker
    ///
    /// # Arguments
    ///
    ...
    ///
    /// Common values:
    /// - 8,000,000 Hz (standard)
    /// - 7,987,200 Hz (some systems)
    ///
    /// # Examples
    ///
    /// ```
    ...
    pub fn new(master_clock_hz: f64) -> Self {
        Self {
            ...
            master_clock_hz,
            current_port: 0,
            registers: Ym2608Storage::default(),
        }
    }
    ...
    fn handle_psg_register(&mut self, register: u8, value: u8) -> Option<Vec<StateEvent>> {
        match register {
            0x00..=0x05 => {
                ...
                let channel = YM2608_FM_CHANNELS + psg_channel;
